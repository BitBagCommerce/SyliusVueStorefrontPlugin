...
final class ResetPasswordAction
{
    ...
    {
        $resetPasswordCommand = ResetPasswordRequest::fromHttpRequest($request);

        $validationResults = $this->validator->validate($resetPasswordCommand);
        ...
        $this->bus->dispatch($resetPasswordCommand);
